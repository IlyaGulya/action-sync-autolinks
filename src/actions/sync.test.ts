...
import { executeSyncAction } from './sync';
...
describe('executeSyncAction with custom repository', () => {
...
describe('executeSyncAction with dry-run', () => {
...
describe('executeSyncAction with 500 projects limit', () => {
  const env = useTestEnv({ inputs: fixtures.inputs.basic });
...
describe('executeSyncAction with project filters', () => {
  const env = useTestEnv({
    inputs: {
      ...fixtures.inputs.basic,
